...
pkgEnv$label_no = list(
  ...
  "User successfully updated" = "Bruker oppdatert",
  "Cancel" = "Avbryt",
  "Confirm new user" = "Bekreft ny bruker",
  "Confirm change" = "Bekreft endring",
  "Are you sure to remove user(s): %s from the database ?" = "Er du sikker du på at du vil fjerne bruker(e): %s fra databasen?",
  "Delete user(s)" = "Slett bruker(e)",
  "Delete user" = "Slett bruker",
  "Edit user" = "Rediger bruker",
  "User already exist!" = "Brukeren eksisterer allerede!",
  "Dismiss" = "Avvis",
  "New user %s succesfully created!" = "Ny bruker %s opprettet!",
  "Ask to change password" = "Be om passordendring",
  "Confirm" = "Bekreft",
  "Ask %s to change password on next connection?" = "Be %s om passordendring ved neste p\u00e5melding?",
  "Change saved!" = "Endring lagret!",
  "Failed to update the database" = "Kunne ikke oppdatere databasen",
  "Password does not respect safety requirements" = "Passordet oppfyller ikke sikkerhetskravene",
